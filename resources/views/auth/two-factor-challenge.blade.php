...
@section('title')
    {{ __('auth.titles.two_factor') }} - {{ __('common.app_name') }}
@stop
                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    ...
                                    <div class="main-signup-header">
                                        <h2>{{ __('auth.headings.two_factor') }}</h2>
                                        <h5 class="font-weight-semibold mb-4">{{ __('auth.messages.two_factor_description') }}</h5>

                                        <form method="POST" action="{{ route('two-factor.login') }}">
                                            @csrf

                                            <div class="form-group">
                                                <label for="code">{{ __('auth.fields.two_factor_code') }}</label>
                                            ...
                                            <div class="text-center mb-2">{{ __('auth.messages.or') }}</div>

                                            <div class="form-group">
                                                <label for="recovery_code">{{ __('auth.fields.recovery_code') }}</label>
